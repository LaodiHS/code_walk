...
document.addEventListener("DOMContentLoaded", function() {
  //###################################################
  //###10421###Comanche##ave###Riverside###CA###92503##
  //###################################################
  ...
  editor.setOption("theme", "dracula");
      ...
      console.log(data.price)
                          ...
                          div.innerHTML = ["<h3>",  data.price , "<small>", date.price , "</small></h3><br>"].join(" ");
                      console.log(data.price);
                  ...
                  urlNode.addEventListener("keydown", (data)=>{
                  data = data.target;
                          
                          setTimeout(()=>{
      console.log("data.value--->",data.value)
                  socket.emit('url', { url: data.value, jsText:"" })
